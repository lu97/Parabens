...
public class ListAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(p.isFavourite()){
                ((ImageView) view.findViewById(R.id.isFavourite)).setImageResource(R.drawable.favourite_true);
            } else{
                ((ImageView) view.findViewById(R.id.isFavourite)).setImageResource(R.drawable.favourite_false);
            }
            return view;
        }
